...
import org.example.finalprojectepamlabapplication.messager.TrainerWorkloadMassagerProducer;
...
public class TrainingServiceImpl implements TrainingService {
    ...
    private final TrainerWorkloadMassagerProducer massagerProducer;

    @Autowired
    public TrainingServiceImpl(TrainingRepository trainingRepository, TrainerWorkloadMassagerProducer massagerProducer) {
